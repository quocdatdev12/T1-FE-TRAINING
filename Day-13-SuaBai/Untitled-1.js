...
//  Output: 19
// Hướng giải quyết
// + snt chia hết cho 1 và chính nó 
...
// Input: 20
// Output: (3, 17), (7, 13)
// so / 2 vì tìm thắng a thì tao tìm đc thằng b ( a + b = n) => b = n - a ;
{
    function bai2(so){
        for(let a = 2 ; a <= so / 2  ; a++ ){
            let b = so - a; // 
            if(kiemTraSoNguyenTo(a) && kiemTraSoNguyenTo(b) && a !== b){
                console.log(a);
                console.log(b);
                console.log(`{${a}, ${b}}`);
            }
