  ...
  return (
    <section className="relative overflow-hidden">
          ...
          <div className="absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
            ...
            <a style={{animationDelay:"0.3s"}} href="#none" className="animate-slideInLeft mt-4 lg:mt-8 h-9 border border-white px-7 inline-flex items-center font-semibold text-white rounded-full text-[15px] hover:bg-white hover:text-black transition-all duration-300">Shop now</a>
          </div>
        </section>
  )
}
